...
import ..EpiBranchEngine: BranchingProcess, _draw_offspring
import Distributions: loglikelihood, fit

# Internal helpers from Base / Engine / Observation
using ..EpiBranchBase: max_cases
using ..EpiBranchObservation: scalar_detection_prob
