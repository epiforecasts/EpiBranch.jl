...
struct WithinChain <: EpiBranch.EpiBranchInterventions.TraceEligibility end
function EpiBranch.EpiBranchInterventions.is_eligible(::WithinChain, parent, contact, state)
...
@testset "ContactTracing trait seams" begin
    ...
    @testset "Custom TraceEligibility trait integrates via constructor" begin
        ...
        @test EpiBranch.EpiBranchInterventions.is_eligible(ct.eligibility,
