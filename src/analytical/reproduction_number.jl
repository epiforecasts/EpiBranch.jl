...
What counts as a unit depends on the specification. For a household-level
offspring law (`EpiHouseholds.household_offspring`) the unit is a household and
the number is R*, the mean number of households infected by the members of one
infected household.
"""
