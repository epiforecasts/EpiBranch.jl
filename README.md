...
EpiBranch.jl is organised as one repository holding seven Julia packages plus a main `EpiBranch` package that re-exports everything they contain. For most users, the main package is what you want:
